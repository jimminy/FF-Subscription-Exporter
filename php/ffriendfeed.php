...
class FriendFeed {
	...
	//Returns user information such as services and Subscriptions
	function fetch_user_profile($nickname, $service=null, $start=0, $num=30)
	{
	return $this->fetch_feed(
	"/api/user/" . urlencode($nickname) . "/profile",
	$service,$start,$num);
	}
